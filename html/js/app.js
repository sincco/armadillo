...
var App = function() {
    var e = $("#page-container"),
        ...
        o = function() {
            ...
            var e = $("#year-copy"),
                a = new Date;
            2015 === a.getFullYear() ? e.html("2015") : e.html("2015-" + a.getFullYear().toString().substr(2, 2)), $("#page-content").css("min-height", $(window).height() - (t.outerHeight() + $("footer").outerHeight()) + "px"), $(window).resize(function() {
